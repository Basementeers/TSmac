...
```toml
foreman = { source = "Basementeers/TSmac", version = "0.7.0" }
```
...
```bash
cargo install --git https://github.com/Basementeers/TSmac
```
...
TSmac will generate Lua code in `src/assets.lua` that looks something like this:
